...
/*
    This is a custom Logging that is being used as a drop in replacement for the the default logging provider in ASP.NET
...
namespace Logging {
    public class Logger(bool b) { 
        ...
        private string LogFile { get; } = $@"{LogsDir}\{LogFileBaseName}.log";
